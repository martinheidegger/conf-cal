...
test('single room', t => {
  ...
  t.deepEquals(slots, [
    {
      start: '11:00', end: '12:00', room: 'a', entry: 
        {start: '11:00', end: '12:00', summary: 'x', person: null, rowSpan: 1}
    },
    {
      start: '12:00', end: '13:00', room: 'a', entry:
...
test('opening entry', t => {
  ...
  t.deepEquals(slots, [
    {
      start: '10:00', end: '11:00', room: 'b', entry:
...
test('multiple opening entries', t => {
  ...
  t.deepEquals(slots, [
    {
      start: '09:00', end: '10:00', room: 'b', entry:
...
test('closing entry', t => {
  ...
  t.deepEquals(slots, [
    ...
    {
      start: '12:00', end: '13:00', room: 'b', entry:
...
test('multiple closing entries', t => {
  ...
  t.deepEquals(slots, [
    ...
    {
      start: '13:00', end: '14:00', room: 'b', entry:
...
test('test with closings and openings', t => {
  ...
  t.deepEquals(slots, [
    {
      start: '11:00', end: '11:20', room: 'a', entry:
        {start: '11:00', end: '11:20', summary: 'opening', person: null, rowSpan: 1}
    },
    {
      start: '11:20', end: '12:00', entries: {
    ...
    {
      start: '12:00', end: '13:30', entries: {
        a: {start: '12:00', end: '13:30', summary: 'y', person: 'B', rowSpan: 1}
      }
    },
    {
      start: '13:30', end: '14:00', entries: {
    ...
    {
      start: '15:00', end: '15:30', room: 'a', entry:
